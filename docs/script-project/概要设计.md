...
本文档描述「剧本项目」模块在**导入剧本**、**历史版本**、**剧本预览**以及**三阶段智能体优化**（场景 / 角色 / 道具）方面的目标架构、数据模型、接口与流水线，与 [开发文档](./开发文档.md) 中的任务拆分与验收标准配套使用。
...
| 模块 | 路径 |
|------|------|
| 剧本项目聚合 | `aigc-server/.../entity/ScriptProjectAggregate.java` |
