...
export function QuickModelForm({ visible, onClose, onSuccess, onOtherProvider, onAdvancedMode }: Props) {
  ...
  const modelOptions = useMemo(() => {
    ...
    return presetData.models.filter((m) => m.provider === selectedProvider)
  ...
  useEffect(() => {
    ...
    const ok = presetData.models.some((m) => m.modelName === selectedModel && m.provider === selectedProvider)
    setUnknownModel(!ok)
