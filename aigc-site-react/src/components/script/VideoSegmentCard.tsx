...
type Props = {
  ...
  onSaveShot?: (shotId: string, payload: { shotType?: string; cameraMove?: string; emotion?: string }) => void
...
export function VideoSegmentCard({
  ...
  }, [shot.shotId, shot.shotType, shot.cameraMove, shot.emotion, shot.storyboardAssetId, shot.firstFrameMode, shot.storyboardCropIndex])
