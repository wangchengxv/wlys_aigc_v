...
export function ModelConfigPage() {
  ...
  const [showOnelinkPromo, setShowOnelinkPromo] = useState(false)
  ...
  useEffect(() => {
    ...
    if (promo !== 'onelink') return
    setShowOnelinkPromo(true)
  ...
  return (
    <section className="model-config-page">
      ...
      <QuickModelForm
        ...
        showOnelinkPromo={showOnelinkPromo}
        onClose={() => {
