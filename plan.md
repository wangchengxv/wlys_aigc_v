...
- 前端已有文生图/文生视频、模型配置、历史记录、路由控制台；
- 存储层已支持基于本地 JSON 的持久化；
- 当前能力更偏“Prompt -> 文本/图片/视频结果”，尚未形成“剧本工程 -> 资产抽取 -> 关键帧 -> 视频流水线”。
...
建议新增一条独立于现有 `/workspace` 的“剧本工作流”，而不是直接改坏现有文生图/文生视频。
