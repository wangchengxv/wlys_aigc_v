...
- [x] Task 1.1: 创建数据库迁移脚本 V23__social_account.sql
...
- [x] Task 5.2: 手动验证流程
  - 第三方 OAuth 入口与回调链路联调验证（onelinkai 主路径）
  - 通过 AuthIntegrationTest 验证解绑后用户名/密码登录链路保持可用
