...
import { resolveVisualStyleForProject } from '@/data/videoStylePresets'
...
onMounted(async () => {
  const gs = globalSettings.snapshot
  form.aspectRatio = gs.aspectRatio
  form.targetDuration = gs.targetDurationSec
  form.visualStyle = resolveVisualStyleForProject({
    visualStyleMode: gs.visualStyleMode,
    visualStylePresetId: gs.visualStylePresetId,
    customVisualStyle: gs.customVisualStyle,
    visualStyleLongTextMode: gs.visualStyleLongTextMode,
  })
