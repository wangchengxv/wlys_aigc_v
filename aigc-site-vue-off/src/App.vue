...
const titleMap: Record<string, string> = {
  home: '首页',
  workspace: '文生图/文生视频',
  'script-projects': '剧本工程',
  'script-project-create': '新建剧本工程',
  ...
  <div class="app-layout">
    <header class="top-nav panel glass">
      ...
      <nav class="links" :class="{ open: navOpen }">
        ...
        <RouterLink to="/global-settings" @click="navOpen = false">全局设定</RouterLink>
        <RouterLink to="/workspace" @click="navOpen = false">文生图/文生视频</RouterLink>
        <RouterLink to="/script-projects" @click="navOpen = false">剧本工程</RouterLink>
        <RouterLink to="/history" @click="navOpen = false">历史记录</RouterLink>
        <RouterLink to="/models" @click="navOpen = false">模型配置</RouterLink>
