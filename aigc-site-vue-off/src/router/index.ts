...
export const router = createRouter({
  ...
  routes: [
    ...
    { path: '/global-settings', name: 'global-settings', component: () => import('@/views/GlobalSettingsView.vue') },
    { path: '/models/hub', name: 'models-hub', component: () => import('@/views/ProviderHubView.vue') },
