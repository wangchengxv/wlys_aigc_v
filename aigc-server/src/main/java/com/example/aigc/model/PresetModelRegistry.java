...
public class PresetModelRegistry {
    ...
    private final List<PresetModel> models = List.of(
        ...
        new PresetModel("onelinkai", "doubao-seedream-4.0", "https://api.onelinkai.cloud", "OneLinkAI 豆包 Seedream 4.0", List.of("image")),
        new PresetModel("onelinkai", "doubao-seedream-4.5", "https://api.onelinkai.cloud", "OneLinkAI 豆包 Seedream 4.5", List.of("image")),
        new PresetModel("onelinkai", "doubao-seedream-5.0-lite", "https://api.onelinkai.cloud", "OneLinkAI 豆包 Seedream 5.0 Lite", List.of("image")),
